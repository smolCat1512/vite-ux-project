...
const CaseStudyShelterSimple = () => {
  return (
    <Main className="p-8 max-w-3xl mx-auto mt-24">
      <div className="flex flex-row gap-4">
        <h1 className="text-4xl font-bold py-8 text-red-500">Shelter</h1>
        <span className="text-4xl font-bold py-8">Digital Advice Web Chat</span>
      </div>
      <p className="text-gray-300">
        Shelter’s outdated chat and call system slowed response times and
      ...
      <section>
        ...
        <p className="font-light">
          ...
          chat connection attempts made daily through their website. They needed
          to maximise efficiency by triaging and prioritising the most urgent
          cases, reducing unnecessary conversations and easing the overall load
          on their service.
        </p>
        <p className="font-light">
        ...
        <article>
          ...
          <ul className="font-light pl-4">
            <li className="list-disc">
              How do users (both agents and end clients) currently perceive the
              app’s usability and overall experience?
            </li>
            <li className="list-disc">
        ...
        <article>
          ...
          <ul className="font-light pl-4">
            ...
            <li className="list-disc">
              ...
              other web chat and voice platforms to identify best practices and
        ...
        <article>
          ...
          <ul className="font-light pl-4">
            ...
            <li className="list-disc">
              ...
              customisation options — meaning opening hours, estimated response
              times, or queue positions could not be displayed.
            </li>
            <li className="list-disc">
      ...
      <article className="mt-6">
        ...
        <p>
          ...
          research, and data analysis, several critical issues emerged affecting
          both service users and Shelter agents. The existing platform lacked
          essential features for effective triage and queue management, limiting
          communication transparency for users and reducing agent efficiency.
          Technical and operational challenges, including poor system
          integration, cumbersome onboarding, and deteriorating performance,
          further hindered the user experience and service delivery. These
          insights shaped the design and engineering priorities to build a more
          efficient, user-friendly chat and call-handling solution.
        </p>
      </article>
      ...
      <section className="mt-6">
        <article>
          ...
          <p className="font-light">
            ...
            iterative process. This involved ideation, wireframing, prototyping,
            and user testing, allowing us to refine the product continuously
        ...
        <article className="mt-6">
          ...
          <ul>
            <li className="list-disc font-light">
              Based on research findings, we generated multiple ideas to address
              the core problems, such as enabling triage, queue visibility, and
              multitasking for agents.
            </li>
            <li className="list-disc font-light">
            ...
            <li className="list-disc font-light">
              ...
              integrated within the Twilio Flex platform, clearly outlining what
              features were being added, their purposes, and how they would
              operate in practice.
            </li>
            <li className="list-disc font-light">
            ...
            <li className="list-disc font-light">
              ...
              such as triage flows, requesting transcripts, ending chats. Also,
              persistence of chat - ensuring that if clients lose connection,
              refresh the browser, or navigate around the website in the
              background - the service remains uninterrupted.
            </li>
          </ul>
        ...
        <article className="mt-6">
          ...
          <ul>
            <li className="list-disc font-light">
              ...
              simulate key user interactions, including queue status updates and
              multitasking interfaces for agents.
            </li>
            <li className="list-disc font-light">
              Prototypes allowed rapid experimentation with layout, theming, and
              messaging to ensure the system was intuitive and met user needs.
            </li>
          </ul>
          <img
            src="/images/project-alpha.jpg"
        ...
        <article className="mt-6">
          ...
          <ul>
            ...
            <li className="list-disc font-light">
              Feedback led to several refinements, such as clearer queue status
              notifications and improved accessibility for agents handling
              multiple chats and calls simultaneously.
            </li>
            <li className="list-disc font-light">
      ...
      <section className="mt-6">
        ...
        <p className="font-light">
          ...
          parts of the application. Using React and TypeScript, I helped develop
          modular, reusable components that brought the design to life while
          ensuring performance and scalability.
        </p>
        <p className="font-light">
          One of the major technical challenges we addressed was enabling agents
          to multitask effectively—handling voice calls and web chats
          ...
          Shelter to create and manage their own triage flows dynamically. This
          included developing a separate Content Manager view for creating and
          editing contact templates used in the flows.
        </p>
        <p className="font-light">
        ...
        <p className="font-light">
          Development was paired with comprehensive testing, including unit and
          integration tests, as well as user acceptance testing with Shelter
          agents to ensure the product met their practical needs. The rollout
          was phased to allow for monitoring and iterative improvements based on
          real-world feedback.
        </p>
        <p>
          ...
          flow builder and content manager empowered Shelter’s administrators to
          adapt quickly to changing needs without relying on engineering
      ...
      <section className="mt-6">
        ...
        <p className="font-light">
          The project is currently in an active Software Development Life Cycle
          (SDLC) phase, with ongoing efforts to resolve bugs and refine
        ...
        <p className="font-light">
          ...
          desirable UX enhancements. Examples include enabling users to drag and
          resize the web chat window on desktop and tablet devices, and the
          ability to expand messages into modals or separate windows for easier
          reading. These features are part of a growing list of improvements
          planned to make the platform more flexible and user-friendly.
        </p>
        <p className="font-light">
          ...
          provide agents with richer context and improve overall case handling.
        </p>
        <p className="font-light">
          This iterative approach underscores a commitment to continuous
          improvement and user-centred design, ensuring the platform evolves in
          step with Shelter’s operational needs and user expectations.
        </p>
        <p className="font-light">
          ...
          alongside a reduction in unwanted traffic, achieved through the use of
          the Twilio Flex Studio product.
        </p>
        <p className="font-light">
          ...
          result of the Flow Builder, which delivers triage, in-queue messaging
          to advise users of wait times and queue position, and directs users to
          other resources when the queue is over capacity.
        </p>
        <p className="font-light">
          Users have reported higher satisfaction with the new service, largely
          due to the ability to answer triage questions that ensure clients are
          directed to the correct team. This also provides agents with advanced
          knowledge of a client’s situation, thanks to labels assigned during
          the triage flow based on client responses, along with free-text inputs
          submitted before the chat connection that summarise the client’s
          issues.
        </p>
        <p className="font-light">
      ...
      <section className="mt-6">
        ...
        <p className="font-light pb-4">
          Close communication and collaboration between design, engineering, and
          Shelter stakeholders were essential to navigating technical
          constraints while delivering a user-centred solution. Regular
          cross-functional check-ins ensured design decisions were feasible and
          aligned with Shelter’s operational needs.
        </p>
        <h3 className="pb-2">Iterative Improvement:</h3>
        <p className="font-light pb-4">
          Continuous feedback loops with agents and end users proved invaluable.
          Early usability testing and ongoing input during rollout helped
          uncover real-world pain points and prioritise improvements. This
          iterative approach enabled the team to adapt quickly and deliver
          meaningful enhancements over time.
        </p>
        <h3 className="pb-2">Transferable Skills:</h3>
        <p className="font-light pb-4">
          This project strengthened my ability to balance technical
          implementation with UX principles within complex platforms like Twilio
          Flex. I gained experience in modular development, integrating UX
          research insights, and managing stakeholder collaboration—skills I
          look forward to applying in future projects.
        </p>
        ...
        <p className="font-light pb-4">
          ...
          such as triage flows and multitasking, anticipating future needs like
          multi-language support and CRM integration proved crucial. The dynamic
          flow builder empowered Shelter to independently adapt workflows,
          boosting operational efficiency.
        </p>
        <p className="font-light">
          Challenges with persistent bugs and edge cases—such as chat
          reconnection and transcript delivery—reinforced the need for rigorous
          testing and phased rollouts. The project highlighted that UX and
          engineering improvements are never truly “done,” requiring sustained
          iteration based on real user feedback. Additionally, I learned that
          even when clients state all key stakeholders were involved from the
          start, new functional and visual requirements can emerge later from
          previously uninvolved parties. This underscores the importance of
          ongoing stakeholder engagement throughout the project lifecycle.
        </p>
      </section>
    </Main>
  );
...
export default CaseStudyShelterSimple;
